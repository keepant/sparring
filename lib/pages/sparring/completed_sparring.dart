...
class CompletedSparring extends StatefulWidget {
  @override
  _CompletedSparringState createState() => _CompletedSparringState();
}

class _CompletedSparringState extends State<CompletedSparring> {
                  ...
                  builder: (QueryResult result,
                    ...
                    if (result.data['sparring'].length == 0) {
                      return EmptyListWidget(
                        ...
                        subTitle: I18n.of(context).noCompletedSparringText,
                        image: null,
